...
const refreshAccessToken = asyncHandler(async (req, res) => {
    const incomingRefreshToken = registerUser.cookies.refreshToken || req.body.refreshToken
...
const updateUserAvatar = asyncHandler(async(req, res) => {
    ...
    if(!avatarLocalPath){
        throw new ApiError(400, "Avaatr file is missing")
    }
...
//Koi gadbad ho to yaah dekh lio bhai yaha jhol ho sakta hai......eeee
    const user = await User.findById(req.user?._id);
    ...
    if (oldAvatarUrl) {
        // Extract publicId from the old avatar URL
